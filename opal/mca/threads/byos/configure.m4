...
AC_DEFUN([MCA_opal_threads_byos_PRIORITY], [30])

AC_DEFUN([MCA_opal_threads_byos_COMPILE_MODE], [
...
# MCA_threads_byos_CONFIG(action-if-can-compile,
#                        [action-if-cant-compile])
# ------------------------------------------------
AC_DEFUN([MCA_opal_threads_byos_CONFIG],[
    AC_CONFIG_FILES([opal/mca/threads/byos/Makefile])
    OPAL_VAR_SCOPE_PUSH([posix_thread_works])

    AS_IF([test "$with_threads" = "byos"],
